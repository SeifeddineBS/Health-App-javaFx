...
public class ServiceAdmin implements IserviceAdmin {
    ...
    public void ajouterAdmin(Admin a) {
        ...
        try {
            ...
            String query = "INSERT INTO `user`(`id`, `nom`, `prenom`, `email`, `password`, `tel`,`specialite`,`adresse`,`role`,`roles`,`picture`) VALUES ('" + a.getId() + "','" + a.getNom() + "','" + a.getPrenom() + "','" + a.getEmail() + "','" + a.getPassword() + "','" + a.getTel() + "','" + "" + "','" + "" + " ','Admin','"+roles+"','"+a.getPicture()+"')";
