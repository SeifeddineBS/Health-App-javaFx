...
public class Create_Account_ClientController implements Initializable {
    ...
    private String MyAdress() {
        ...
        try {
            ...
            Logger.getLogger(Create_Account_ClientController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void ajouter_client(ActionEvent event) throws Exception {
        ...
        } else if (!adresse_cl.isSelected()) {
            alert_Box("Verifier Votre Adresse", "Veuillez autoriser l'accés a votre emplacement!");
    ...
    private void upload_pic_client(ActionEvent event) {
        ...
        picture_label.setText(filename);
