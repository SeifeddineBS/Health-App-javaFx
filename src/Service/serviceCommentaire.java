...
public class serviceCommentaire implements Icommentaire {
    ...
    public void supprimerc(commentaire com, String id_user) {
        ...
        try {
            Statement st = cnx.createStatement();
            String query = "DELETE FROM commentaire WHERE id = '" + com.getId() + "' AND id_user ='" + id_user+"' ";
   ...
   PDFRenderer pdfRenderer = new PDFRenderer(document);
    ...
    public void modifier(commentaire c,String id_user) {
        ...
        try {
            ...
            String query = "UPDATE  commentaire SET commentaire = '" + c.getCommentaire() + "'  WHERE id_user = '"+ c.getId_user()+ "'  AND id_user='"+id_user+"' ";
            st.executeUpdate(query);
