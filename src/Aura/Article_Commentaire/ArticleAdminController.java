...
public class ArticleAdminController implements Initializable {
    ...
    private void approuverarticle(ActionEvent event) throws IOException {
        ...
        String k;
        k = a.getArticle();
        String directoryUploads = "C:\\Users\\SeifBS\\Documents\\NetBeansProjects\\AuraWeb\\AuraWeb\\public\\uploads\\";
        String directoryUploads1 = "C:\\Users\\SeifBS\\Documents\\NetBeansProjects\\AuraWeb\\AuraWeb\\public\\uploads1\\";

        Path from = Paths.get(directoryUploads + k);
        Path to = Paths.get(directoryUploads1+ k);
